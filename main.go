...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "d8f7e1ac.openshiftdemos.github.io",
	})
	if err != nil {
	...
	if err = (&controllers.BlenderRenderReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "BlenderRender")
		os.Exit(1)
	}
